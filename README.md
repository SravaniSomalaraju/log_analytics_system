...
The system performs log ingestion, block analysis, distributed processing using MapReduce, Python-based streaming analytics, and performance tuning.

##Dataset

Web access logs in the format:
Sample dataset source: Kaggle – Website Log Access Dataset.
